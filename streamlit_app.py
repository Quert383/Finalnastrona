...
# --- Podsumowanie naruszeń (tylko raz, po wszystkich pytaniach) ---
...
Maksymalna wysokość MPKK = 45% całkowitej kwoty kredytu""")
    ...
    if st.session_state.get("MPKK"):
        ...
        if przekroczone == "Tak":
            naruszenia.append("Rzeczywiste pozaodsetkowe koszty kredytu przekraczają maksymalny dopuszczalny limit MPKK.")
            st.error("Przekroczenie limitu MPKK stanowi podstawę do zastosowania sankcji SKD (art. 45 ust. 1 ustawy o kredycie konsumenckim).")
